...
public class Client57017355 {
    ...
    public static Matrix remoteMultiply(String host, int port, Matrix matA, Matrix matB) {
        ...
        try {
            ...
            Logger.getLogger(Client57017355.class.getName()).log(Level.SEVERE, "Unknown host", e);
        } catch (IOException e) {
            Logger.getLogger(Client57017355.class.getName()).log(Level.SEVERE, "Cannot read the Matrix", e);
