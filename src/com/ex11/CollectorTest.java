...
public class CollectorTest {
    ...
    public static void main(String[] args) {
        ...
        // To obtain a set of unique surnames (removing duplicates)
        ...
        // To obtain a set of unique surnames sorted in natural order
        ...
        Map<Gender, Long> countPeopleByGender = persons.stream()
                .collect(Collectors.groupingBy(Person::getGender, Collectors.counting()));  // downstream collector
